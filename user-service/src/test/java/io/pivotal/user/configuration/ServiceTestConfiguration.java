 ...
 */
package io.pivotal.user.configuration;
...
public class ServiceTestConfiguration  {
	...
	public UserService userService() {
		UserService accountService = Mockito.mock(UserService.class);
		...
		when(accountService.findUser(eq(ACCOUNT_ID))).thenReturn(user());
